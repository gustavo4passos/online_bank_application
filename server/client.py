...
def Main(): 
    ...
    while True: 
        ...
        # s.send('{ "op": "l", "account": "3588", "password": "tressim" }'.encode('ascii'))
        s.send('{ "op": "l", "account": "3579", "password": "12345" }'.encode('ascii'))
        # s.send('{ "op": "t", "account": "3584", "token": "tressim", "destination_account": "3579", "amount": 16 }'.encode('ascii'))
        # s.send('{ "op": "g", "account": "3584"}'.encode('ascii'))
        # s.send('{ "op": "r", "account_to_remove": "3584", "token": "12345", "account": "3579" }'.encode('ascii'))
        # s.send('{ "op": "l", "account": "3579", "password": "12345d" }'.encode('ascii'))
